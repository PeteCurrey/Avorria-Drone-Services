const coreServices = [
  {
    ...
    metaDescription: 'Professional drone inspection services across the UK. Thermal imaging, defect reporting, and structural assessments for roofing, facades, and infrastructure. CAA approved.',
    heroStat: [
    ...
    capabilities: [
      ...
      { title: 'High-Resolution Zoom', description: 'Identifying millimetre-scale defects from a safe standoff.' }
    ],
  ...
  },
  {
    ...
    metaDescription: 'Professional aerial photography and drone filming services across the UK. 4K/6K video, 45MP stills for real estate, commercial, and broadcast. CAA approved.',
    heroStat: [
  ...
  },
  {
    ...
    metaDescription: 'Professional events drone coverage. Article 16 licensed for operations over crowds. Festivals, concerts, sport and film. CAA approved.',
    heroStat: [
  ...
  },
  {
    ...
    metaDescription: 'Professional agricultural drone surveys. NDVI crop health mapping, multispectral analysis and drainage assessment. CAA approved.',
    heroStat: [
